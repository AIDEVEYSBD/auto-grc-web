...
export default function Topbar() {
  ...
  return (
    <header className="glass-topbar h-16 flex items-center justify-between px-4 sm:px-6 relative z-[100]">
      ...
      <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
        ...
        <div className="relative z-[200]" ref={menuRef}>
          <button
            ...
            className="flex items-center gap-2 p-1.5 rounded-lg hover:bg-white/20 dark:hover:bg-slate-700/50 transition-colors relative z-[201]"
          >
          ...
          {isUserMenuOpen && (
            <>
              ...
              <div className="fixed inset-0 z-[199]" onClick={() => setIsUserMenuOpen(false)} />

              {/* Actual menu */}
              <div className="absolute right-0 mt-2 w-48 rounded-xl bg-white/95 dark:bg-slate-800/100 backdrop-blur-md border border-white/30 dark:border-slate-700/50 shadow-xl z-[200]">
                <div className="py-2">
